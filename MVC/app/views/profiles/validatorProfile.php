    ...
    <div class="pd_content">
        ...
        <div class="user_data">
            ...
            <div class="info_segment"><label>First name</label>
                <div class="value"><?php echo $validatorTable->firstName; ?></div>
            </div>
            <div class="info_segment"><label>Last name</label>
                <div class="value"><?php echo $validatorTable->lastName; ?></div>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="input-field">
                    ...
                    <input
                        ...
                        name="firstName"
                        value="<?= $validatorTable->firstName ?>">
                </div>
                ...
                <div class="input-field">
                    ...
                    <input
                        ...
                        name="contactNo"
                        pattern="[0-9]{10}"
                        value="<?= $validatorTable->contactNo ?>">
                </div>
